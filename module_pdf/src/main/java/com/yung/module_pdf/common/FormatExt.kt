...
fun FileInfoFormat.getResId(): Int {
    return when (this) {
        FileInfoFormat.PDF -> R.mipmap.module_pdf_edit_icon_pdf
        FileInfoFormat.Word -> R.mipmap.module_pdf_edit_icon_word
        FileInfoFormat.Excel -> R.mipmap.module_pdf_edit_icon_excel
        FileInfoFormat.PPT -> R.mipmap.module_pdf_edit_icon_ppt
        FileInfoFormat.Image -> R.mipmap.module_pdf_edit_icon_tp
    }
}
